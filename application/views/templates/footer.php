...
<!-- Modal Add / Edit User -->
<div class="modal fade" id="userModal" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel"
	 aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<form action="<?= base_url('manage/adduser'); ?>" method="POST" autcomplete="OFF">
					...
					<div class="form-group row passForm">
						...
						<div class="col-sm-9">
							<input autocomplete="off" name="password1" type="password" class="form-control" id="password1"
					...
					<div class="form-group row passForm">
						...
						<div class="col-sm-9">
							<input autocomplete="off" name="password2" type="password" class="form-control" id="password2"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row form-group">
					...
					<div class="col-sm-9">
						<input id="ans2" type="number" autocomplete="off" class="form-control"
							   placeholder="Input Jawaban">
					</div>
				</div>
...
<div class="modal fade" id="returnBookModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	 aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">

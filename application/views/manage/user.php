		...
		<div class="col-6">
			<form action="http://localhost/SPB/manage/searchUser" method="post">
				<div class="input-group">
					...
					<input name="keywordNama" id="keywordNama" autocomplete="off" type="text" class="w-50 form-control"
						   placeholder="Cari Nama User" required>
				...
				<div class="table-responsive">
					...
					<table class="table table-hover">
						...
						<?php $i = 0; foreach ($user as $u) { $i++; ?>
							<tr>
								<th schope="row"><?= count($user) ?></th>
								<td><?= $u['name'] ?></td>
								<td><?= $u['username'] ?></td>
								<td style="text-align: center;">
									<a class="ubahUser" href="#" data-toggle="modal" data-target="#userModal"
									   data-id="<?= $u['id'] ?>"><i class="fas fa-edit"></i></a>
									<a class="tombolHapusUser" href="#" data-toggle="modal" data-target="#deleteUserModal" data-id="<?= $u['id'] ?>"><i
